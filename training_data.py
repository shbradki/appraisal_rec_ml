...
def make_row(order_id, subject, candidate, address, is_comp):
    return {
        ...
        "lot_size_diff_sf": candidate.get('lot_size_diff_sf'),
        ...
        "basement_score_diff": candidate.get('basement_score_diff'),
        ...
        "abs_lot_size_diff_sf": safe_abs(candidate.get("lot_size_diff_sf")),
        "abs_gla_diff": safe_abs(candidate.get("gla_diff")),
        "abs_basement_score_diff": safe_abs(candidate.get('basement_score_diff')),
